...
- **Category**: Code
- **Docs**: [https://elements.ai-sdk.dev/components/agent](https://elements.ai-sdk.dev/components/agent)
- **Install**: `npx ai-elements@latest add agent`

## Description

Displays AI agent configuration including name, model, instructions, available tools (with expandable JSON schemas), and output schema. Useful for debugging, documentation, or agent builder UIs.

## Tags

`agent, configuration, tools, instructions, model, schema, debug`
