...
- **Category**: Code
- **Docs**: [https://elements.ai-sdk.dev/components/test-results](https://elements.ai-sdk.dev/components/test-results)
- **Install**: `npx ai-elements@latest add test-results`

## Description

Display test execution results with pass/fail status per test.

## Tags

`tests, results, pass, fail, vitest, jest, testing`
