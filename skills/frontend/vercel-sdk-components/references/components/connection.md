...
- **Category**: Workflow
- **Docs**: [https://elements.ai-sdk.dev/components/connection](https://elements.ai-sdk.dev/components/connection)
- **Install**: `npx ai-elements@latest add connection`

## Description

Visual connection lines between workflow nodes.

## Tags

`connection, line, link, wire, edge-visual`
