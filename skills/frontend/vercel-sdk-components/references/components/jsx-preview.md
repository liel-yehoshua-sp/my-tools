...
- **Category**: Code
- **Docs**: [https://elements.ai-sdk.dev/components/jsx-preview](https://elements.ai-sdk.dev/components/jsx-preview)
- **Install**: `npx ai-elements@latest add jsx-preview`

## Description

Live preview of JSX/React components rendered in an isolated context.

## Tags

`jsx, preview, react, live, render, component`
